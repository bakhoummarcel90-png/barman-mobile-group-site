    ...
    <>
      ...
      <section className="relative flex min-h-[92vh] items-end overflow-hidden bg-nuit">
        <div className="absolute inset-0">
          <PlaceholderImage
            description="Barman Mobile Group en pleine préparation de cocktails lors d'une réception au Sénégal"
            src="/images/hero-barman-mobile.webp"
      ...
      <section className="bg-nuit px-5 py-24">
        <div className="mx-auto max-w-6xl grid gap-12 lg:grid-cols-2 lg:items-center">
          <Reveal>
            <PlaceholderImage
              description="Marcel Bakhoum préparant un cocktail avec soin pendant une prestation"
      ...
      <section className="bg-nuit px-5 py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 md:grid-cols-4">
            {[
              { src: "/images/gallery/cocktail-lineup.webp", alt: "Présentation de cocktails Barman Mobile Group lors d'une réception" },
              { src: "/images/gallery/bar-service-smoke.webp", alt: "Préparation spectaculaire au bar pendant une prestation" },
              { src: "/images/gallery/team-bar.webp", alt: "Équipe Barman Mobile Group devant son bar mobile" },
              { src: "/images/gallery/cocktail-orange.webp", alt: "Cocktail soigneusement présenté avec une garniture d'orange" },
            ].map((photo, i) => (
              <Reveal key={photo.src} delayMs={i * 60}>
                <PlaceholderImage description={photo.alt} src={photo.src} aspect="aspect-square" />
              </Reveal>
            ))}
          </div>
